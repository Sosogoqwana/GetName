...
namespace StarWarsAPIUnitTest
{
    ...
    public class PeopleUnitTest : StarWarsBaseUnitTest
    {
        ...
        void TestObject(People p)
        {
            ...
            Assert.AreEqual(p.homeworld, "http://swapi.dev/api/planets/1/");
            Assert.AreEqual(p.GetHomeworldAsync().Result.url, "http://swapi.dev/api/planets/1/");
            ...
            Assert.AreEqual(p.url, "http://swapi.dev/api/people/1/");
        }
        ...
        public async Task GetAllPeople()
        {
            ...
            Assert.AreEqual(obj.next, "http://swapi.dev/api/people/?page=2");
            ...
            //Assert
            Assert.AreEqual(obj.next, "http://swapi.dev/api/people/?page=3");
            Assert.AreEqual(obj.previous, "http://swapi.dev/api/people/?page=1");
            Assert.IsNotNull(obj.results);
            Assert.AreEqual(obj.results.Count(), 10);
